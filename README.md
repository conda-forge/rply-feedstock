About rply-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rply-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/alex/rply

Documentation: https://rply.readthedocs.io/en/latest/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4312&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rply-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rply` can be installed with `conda`:
...
It is possible to list all of the versions of `rply` available on your platform with `conda`:
...
```
mamba search rply --channel conda-forge
```
...
mamba repoquery search rply --channel conda-forge

# List packages depending on `rply`:
mamba repoquery whoneeds rply --channel conda-forge

# List dependencies of `rply`:
mamba repoquery depends rply --channel conda-forge
```
